...
export function FoodSafetyPage() {
  ...
  const [foodType, setFoodType] = useState<'hot' | 'cold' | 'reheat' | 'fridge' | 'frozen' | ''>('');
                  ...
                  <span className={`inline-block px-2 py-0.5 rounded text-xs font-medium ${
                    {
                      ...
                      frozen: 'bg-violet-100 text-violet-700 dark:bg-violet-900/30 dark:text-violet-400',
                    }[log.food_type]
                  }`}>
                    {{ hot: 'Hot', cold: 'Cold', reheat: 'Reheat', fridge: 'Fridge', frozen: 'Frozen' }[log.food_type]}
                  </span>
                </td>
